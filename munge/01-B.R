...
write.xlsx(jctCohortCode, "output/tbl_jctCohortCode.xlsx", row.names=F)
write.xlsx(osfaCode, "output/tbl_osfaCode.xlsx", row.names=F)
write.xlsx(studentID, "output/tbl_studentID.xlsx", row.names=F)

write.xlsx(as.data.frame(tbl.balance), "output/tbl_balance.xlsx", row.names=F)
write.xlsx(as.data.frame(tbl.BannerCohorts), "output/tbl_BannerCohorts.xlsx", row.names=F)
write.xlsx(as.data.frame(tbl.CohortAwd), "output/tbl_CohortAwd.xlsx", row.names=F)
write.xlsx(as.data.frame(tbl.fundBalance), "output/tbl_fundBalance.xlsx", row.names=F)
write.xlsx(as.data.frame(tbl.GaCommit), "output/tbl_GaCommit.xlsx", row.names=F)
write.xlsx(as.data.frame(tbl.GaCommitmentFundList.OSFA), "output/tbl_GaCommitFundList.xlsx", row.names=F)
write.xlsx(tbl.scholar, "output/tbl_scholar.xlsx", row.names=F)
write.xlsx(as.data.frame(tbl.studentBalance), "output/tbl_studentBalance.xlsx", row.names=F)
write.xlsx(studentID, "output/tbl_studentID.xlsx", row.names=F)
